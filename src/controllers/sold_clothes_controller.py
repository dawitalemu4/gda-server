...
class sold_clothes_queries(viewsets.ViewSet):
    ...
    def get_clothing_by_id(self, request, id):
        ...
        try:
            clothing_by_id = db.execute(
                "SELECT * FROM sold_clothes WHERE id = %s", (id))
    ...
    def create_clothing(self, request):
        ...
        try:
            ...
            input = sold_clothes_model(title=data['title'], description=data['description'], category=data['category'], size=data['size'],
                                       measurements=data['measurements'], gender=data['gender'], notes=data['notes'], thumbnail=data['thumbnail'], gallery=gallery_str)
    ...
    def update_clothing(self, request, id):
        ...
        try:
            ...
            gallery_str = to_string(data)
            input = sold_clothes_model(title=data['title'], description=data['description'], category=data['category'], size=data['size'],
                                       measurements=data['measurements'], gender=data['gender'], thumbnail=data['thumbnail'], gallery=gallery_str)
    ...
    def delete_clothing(self, request, id):
        ...
        try:
            delete_clothing = db.execute(
                "DELETE FROM sold_clothes WHERE id = %s", (id))
